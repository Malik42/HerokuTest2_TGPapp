...
10.times do
  user_random = User.create!(first_name: Faker::Name.first_name ,last_name: Faker::Name.last_name , age: rand(1..100), description: Faker::Hipster.sentence ,email: Faker::Internet.email , city_id: rand(1..City.count), password: Faker::Internet.password(8) )
end
